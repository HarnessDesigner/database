...
class PJTWiresTable(PJTTableBase):
    ...
    def insert(self, part_id: int, circuit_id: int, start_coord3d_id: int | None, stop_coord3d_id: int | None,
        ...
        db_id = PJTTableBase.insert(self, project_id=self.project_id, part_id=part_id, circuit_id=circuit_id,
...
class PJTWire(PJTEntryBase):
    ...
    @property
    def start_coord3d(self) -> "_pjt_coordinate_3d.PJTCoordinate3D":
    ...
    @property
    def stop_coord3d(self) -> "_pjt_coordinate_3d.PJTCoordinate3D":
    ...
    @property
    def start_coord2d(self) -> "_pjt_coordinate_2d.PJTCoordinate2D":
    ...
    @property
    def stop_coord2d(self) -> "_pjt_coordinate_2d.PJTCoordinate2D":
