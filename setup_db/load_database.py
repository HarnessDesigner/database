...
def _build_wires(con, cur):
    ...
    series_id = get_series_id(con, cur, 'M22759/32', 2)
    ...
    for awg in range(8, 31, 2):
        ...
        for p_id in range(10):
            ...
            values.append((part_number, 2, description, str(mm_2), awg, p_id, None, family_id, series_id, 7))
            for s_id in range(10):
                ...
                values.append((part_number + str(s_id), 2, description, str(mm_2), awg, p_id, s_id, family_id, series_id, 7))
...
def wires(con, cur):
    ...
    cur.executemany('INSERT INTO wires (part_number, mfg_id, description, size_mm2, '
                    'size_awg, color_id, stripe_color_id, family_id, series_id, core_material_id) '
                    'VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?);', _build_wires(con, cur))
    con.commit()
